...
public class StoredLtrQueryIT extends BaseIntegrationTest {
  ...
  public void testScriptFeatureUseCase() throws Exception {
    ...
    CreateModelFromSetRequestBuilder createModelFromSetRequestBuilder =
        new CreateModelFromSetRequestBuilder(client());
    createModelFromSetRequestBuilder.withVersion(
  ...
  public void testFullUsecase() throws Exception {
    ...
    CachesStatsNodesResponse stats =
        client()
    ...
    assertEquals(
        model.compile(parserFactory()).ramBytesUsed(), stats.getAll().getModels().getRam());
