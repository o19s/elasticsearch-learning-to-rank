...
public class LoggingIT extends BaseIntegrationTest {
  ...
  public void prepareModels() throws Exception {
    ...
    features.add(
        new StoredFeature(
            "derived_feature", Collections.singletonList("query"), "derived_expression", "100"));

    StoredFeatureSet set = new StoredFeatureSet("my_set", features);
    addElement(set);
    StoredLtrModel model =
        new StoredLtrModel(
            "my_model",
            set,
            new StoredLtrModel.LtrModelDefinition(
                "model/linear", LinearRankerParserTests.generateRandomModelString(set), true));
    addElement(model);
  }
  ...
  public void testFailures() throws Exception {
    ...
    buildIndex();
    QueryBuilder query =
        QueryBuilders.matchQuery("field1", "found")
        ...
        new SearchSourceBuilder()
            ...
            .ext(
                Collections.singletonList(
                    new LoggingSearchExtBuilder().addQueryLogging("first_log", "test", false)));
    ...
    SearchSourceBuilder sourceBuilder2 =
        new SearchSourceBuilder()
            .query(query)
            .fetchSource(false)
            .size(10)
            .ext(
                Collections.singletonList(
                    new LoggingSearchExtBuilder().addQueryLogging("first_log", "not_sltr", false)));
    ...
    SearchSourceBuilder sourceBuilder3 =
        new SearchSourceBuilder()
            .query(query)
            .fetchSource(false)
            .size(10)
  ...
  private void assertExcWithMessage(
      ThrowingRunnable r, Class<? extends Exception> exc, String msg) {
  ...
  public void testLog() throws Exception {
    ...
    StoredLtrQueryBuilder sbuilder =
    ...
    StoredLtrQueryBuilder sbuilder_rescore =
        new StoredLtrQueryBuilder(LtrTestUtils.nullLoader())
            .featureSetName("my_set")
            .params(params)
    ...
    SearchSourceBuilder sourceBuilder =
        new SearchSourceBuilder()
            ...
            .size(10)
            .addRescorer(
                new QueryRescorerBuilder(new WrapperQueryBuilder(sbuilder_rescore.toString())))
            .ext(
                Collections.singletonList(
        ...
        QueryBuilders.boolQuery()
            ...
            .must(
                QueryBuilders.nestedQuery(
                        "nesteddocs1",
                        QueryBuilders.boolQuery()
                            .filter(QueryBuilders.termQuery("nesteddocs1.field1", "nestedvalue")),
                        ScoreMode.None)
