...
public class TransportLTRStatsActionTests extends ESIntegTestCase {
  ...
  public void testNewResponse() {
    ...
    LTRStatsNodesResponse ltrStatsResponse =
        action.newResponse(ltrStatsRequest, responses, failures);
  ...
  public void testNodeOperation() {
    ...
    LTRStatsNodeResponse response =
        action.nodeOperation(new LTRStatsNodeRequest(ltrStatsRequest), null);
