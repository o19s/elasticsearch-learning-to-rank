...
public class StoredFeatureSetTests extends LuceneTestCase {
  ...
  public void testAppend() throws IOException {
    ...
    expectThrows(
        IllegalArgumentException.class, () -> set2.append(singletonList(randomFeature("feat1"))));
    assertSame(v1, set2.feature(0));
    set.validate();
    set2.validate();
  }
  ...
  public void testAppendMaxSize() throws IOException {
    ...
    List<StoredFeature> features =
        IntStream.range(0, StoredFeatureSet.MAX_FEATURES)
  ...
  public void testMergeMaxSize() throws IOException {
    ...
    List<StoredFeature> features =
        IntStream.range(0, StoredFeatureSet.MAX_FEATURES - 2)
            .mapToObj(wrapIntFuncion((i) -> randomFeature("feat" + i)))
            .collect(Collectors.toList());
    StoredFeatureSet set_v2 =
        set_v1
            .append(features)
            .merge(
                asList(
