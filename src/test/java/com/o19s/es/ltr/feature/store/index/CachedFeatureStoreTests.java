...
public class CachedFeatureStoreTests extends LuceneTestCase {
  ...
  public void testCachedFeature() throws IOException {
    ...
    assertEquals(
        feat.ramBytesUsed(), caches.getPerStoreStats(memStore.getStoreName()).featureRam());
    ...
    assertThat(
        expectThrows(IOException.class, () -> store.load("unk")).getCause(),
  ...
  public void testCachedFeatureSet() throws IOException {
    ...
    assertEquals(
        set.ramBytesUsed(), caches.getPerStoreStats(memStore.getStoreName()).featureSetRam());
    ...
    assertThat(
        expectThrows(IOException.class, () -> store.loadSet("unk")).getCause(),
        instanceOf(IllegalArgumentException.class));
  }
  ...
  public void testCachedModelSet() throws IOException {
    ...
    assertEquals(1, caches.getPerStoreStats(memStore.getStoreName()).totalCount());
    assertThat(
        expectThrows(IOException.class, () -> store.loadModel("unk")).getCause(),
        instanceOf(IllegalArgumentException.class));
  }
