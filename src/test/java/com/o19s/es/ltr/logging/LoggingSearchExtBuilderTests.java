...
public class LoggingSearchExtBuilderTests extends ESTestCase {
  ...
  public void testFailOnNoLogSpecs() throws IOException {
    String data = "{}";
    ParsingException exc =
        expectThrows(
            ParsingException.class, () -> parse(createParser(JsonXContent.jsonXContent, data)));
  ...
  public void assertTestExt(LoggingSearchExtBuilder actual) {
    List<LoggingSearchExtBuilder.LogSpec> logSpecs =
        actual.logSpecsStream().collect(Collectors.toList());
