...
public class XGBoostJsonParserV2Tests extends LuceneTestCase {
    ...
    public void testReadLeaf() throws IOException {
        ...
        assertEquals(0.5, tree.score(featureVector), Math.ulp(0.1F));
    }
