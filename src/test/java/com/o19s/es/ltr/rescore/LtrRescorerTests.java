...
public class LtrRescorerTests extends LuceneTestCase {
    ...
    private LtrRescorer.LtrRescoreContext prepareLtrContext(int wSize) {
        ...
        context.setQueryNormalizer(new Normalizer.IntervalNormalizer(0F, 1F, false, new Normalizer.Saturation(0.5F, 1F)));
        context.setRescoreQueryNormalizer(new Normalizer.IntervalNormalizer(1F, 2F, false, new Normalizer.Saturation(0.5F, 1F)));
    ...
    public void testCombine() {
        ...
        for (LtrRescorer.LtrRescoreMode mode : LtrRescorer.LtrRescoreMode.values()) {
            ...
            float expected = mode.combine(ctx.normalizedQueryScore(qscore), ctx.normalizedRescoreQueryScore(rscore));
