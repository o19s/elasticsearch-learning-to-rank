...
public class LtrRescoreBuilderTests extends AbstractBuilderTestCase {
    ...
    public void testRewrite() throws IOException {
        Supplier<LtrRescoreBuilder> supplier = () -> new LtrRescoreBuilder()
                ...
                .setQueryNormalizer(new Normalizer.Saturation(randomFloat()+Float.MIN_VALUE, randomFloat()+Float.MIN_VALUE))
                .setRescoreQueryNormalizer(new Normalizer.Logistic(randomFloat()+Float.MIN_VALUE, randomFloat()))
                .setQueryWeight(randomFloat())
                .setRescoreQueryWeight(randomFloat())
