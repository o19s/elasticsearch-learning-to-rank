...
public class CachesStatsAction extends ActionType<CachesStatsNodesResponse> {
  ...
  public static class CachesStatsNodesResponse extends BaseNodesResponse<CachesStatsNodeResponse>
    ...
    public CachesStatsNodesResponse(
        ...
        List<CachesStatsNodeResponse> nodes,
    ...
    protected List<CachesStatsNodeResponse> readNodesFrom(StreamInput in) throws IOException {
      return in.readCollectionAsImmutableList(CachesStatsNodeResponse::new);
    }

    @Override
    protected void writeNodesTo(StreamOutput out, List<CachesStatsNodeResponse> nodes)
        throws IOException {
