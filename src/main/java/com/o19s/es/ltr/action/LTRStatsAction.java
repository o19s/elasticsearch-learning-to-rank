...
public class LTRStatsAction extends ActionType<LTRStatsAction.LTRStatsNodesResponse> {
  ...
  public static class LTRStatsNodesResponse extends BaseNodesResponse<LTRStatsNodeResponse>
    ...
    protected List<LTRStatsNodeResponse> readNodesFrom(StreamInput in) throws IOException {
      return in.readCollectionAsImmutableList(LTRStatsNodeResponse::new);
    }

    @Override
    protected void writeNodesTo(StreamOutput out, List<LTRStatsNodeResponse> nodeResponses)
        throws IOException {
