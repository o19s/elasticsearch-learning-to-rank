...
public class TransportClearCachesAction
    extends TransportNodesAction<
        ...
        ClearCachesNodesResponse,
        TransportClearCachesAction.ClearCachesNodeRequest,
        ClearCachesNodeResponse> {
  ...
  @Override
  protected ClearCachesNodeResponse newNodeResponse(StreamInput in, DiscoveryNode node)
      throws IOException {
    return null; // TODO
  }
