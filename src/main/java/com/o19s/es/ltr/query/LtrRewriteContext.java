...
/**
 * Contains context needed to rewrite queries to holds the vectorSupplier and provide extra logging
 * support
 */
public class LtrRewriteContext {
   ...
   *
   * <p>The returned consumer will only be non-null during the logging fetch phase
   *
