...
/**
 * Naive implementation of additive decision tree. May be slow when the number of trees and tree
 * complexity if high comparatively to the number of features.
 */
public class NaiveAdditiveDecisionTree extends DenseLtrRanker implements Accountable {
  ...
  /**
   * TODO: Constructor for these classes are strict and not really designed for a fluent building
   * process. We might consider changing this according to model parsers we implement.
   *
   ...
   */
  public NaiveAdditiveDecisionTree(
      Node[] trees, float[] weights, int modelSize, Normalizer normalizer) {
