...
public class RestAddFeatureToSet extends FeatureStoreBaseRestHandler {
  ...
  public List<Route> routes() {
    return unmodifiableList(
        asList(
            ...
            new Route(
                RestRequest.Method.POST, "/_ltr/{store}/_featureset/{name}/_addfeatures/{query}"),
  ...
  protected RestChannelConsumer prepareRequest(RestRequest request, NodeClient client)
    ...
    if (featureQuery == null && (features == null || features.isEmpty())) {
      throw new IllegalArgumentException(
          "features must be provided as a query for the feature store "
  ...
  static class FeaturesParserState {
    ...
    public static final ObjectParser<FeaturesParserState, Void> PARSER =
        new ObjectParser<>("features");
