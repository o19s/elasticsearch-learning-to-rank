...
public class RestStoreManager extends FeatureStoreBaseRestHandler {
  ...
  RestChannelConsumer listStores(NodeClient client) {
    return (channel) ->
        new ListStoresAction.ListStoresActionBuilder(client)
            ...
            .execute(
                new RestBuilderListener<GetIndexResponse>(channel) {
                  ...
                  public RestResponse buildResponse(
                      GetIndexResponse indexResponse, XContentBuilder builder) throws Exception {
                    builder
                        .startObject()
  ...
  RestChannelConsumer createIndex(NodeClient client, String indexName) {
    return (channel) ->
        client
            ...
            .indices()
            .create(
                IndexFeatureStore.buildIndexRequest(indexName),
