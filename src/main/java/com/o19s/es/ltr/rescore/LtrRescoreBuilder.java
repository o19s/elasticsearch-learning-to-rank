...
public class LtrRescoreBuilder extends RescorerBuilder<LtrRescoreBuilder> {
    ...
    private float queryWeight = 1F;
    private float rescoreQueryWeight = 1F;
    ...
    static {
        ...
        PARSER.declareFloat(LtrRescoreBuilder::setQueryWeight, QUERY_WEIGHT);
        PARSER.declareFloat(LtrRescoreBuilder::setRescoreQueryWeight, RESCORE_QUERY_WEIGHT);
    ...
    public LtrRescoreBuilder setQueryWeight(float queryWeight) {
    ...
    public LtrRescoreBuilder setRescoreQueryWeight(float rescoreQueryWeight) {
    ...
    public boolean equals(Object o) {
        ...
        return Float.compare(builder.queryWeight, queryWeight) == 0 &&
                Float.compare(builder.rescoreQueryWeight, rescoreQueryWeight) == 0 &&
