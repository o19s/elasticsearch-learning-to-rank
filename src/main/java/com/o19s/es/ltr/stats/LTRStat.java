...
/**
 * A container for a stat provided by the plugin. Each instance is associated with an underlying
 * supplier. The stat instance also stores a flag to indicate whether this is a cluster level or a
 * node level stat.
 */
