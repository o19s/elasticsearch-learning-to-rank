...
public class StandardFeatureNormDefinition implements FeatureNormDefinition {
  ...
  public void setStdDeviation(float stdDeviation) {
    if (stdDeviation <= 0.0f) {
      throw new ElasticsearchException(
          "Standard Deviation Must Be Positive. " + " You passed: " + Float.toString(stdDeviation));
    }
  ...
  public static StandardFeatureNormDefinition parse(XContentParser parser, String context)
      throws IOException {
