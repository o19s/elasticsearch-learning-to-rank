...
public class FeatureSupplier extends AbstractMap<String, Float>
  ...
  /**
   * Returns {@code true} if this map contains a mapping for the specified featureName.
   *
   * @param featureName featureName whose presence in this map is to be tested
   * @return {@code true} if this map contains a mapping for the specified featureName
   ...
   * @return the score to which the specified featureName is mapped, or {@code null} if this map
