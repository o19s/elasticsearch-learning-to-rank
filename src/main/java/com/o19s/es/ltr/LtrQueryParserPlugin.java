...
public class LtrQueryParserPlugin extends Plugin
    implements SearchPlugin, ScriptPlugin, ActionPlugin, AnalysisPlugin {
  ...
  public LtrQueryParserPlugin(Settings settings) {
    ...
    parserFactory =
        new LtrRankerParserFactory.Builder()
  ...
  public List<QuerySpec<?>> getQueries() {
    ...
    return asList(
        new QuerySpec<>(
            ...
            ExplorerQueryBuilder::new,
            ExplorerQueryBuilder::fromXContent),
        ...
        new QuerySpec<>(
            TermStatQueryBuilder.NAME,
            TermStatQueryBuilder::new,
            TermStatQueryBuilder::fromXContent),
        new QuerySpec<>(
  ...
  public List<SearchExtSpec<?>> getSearchExts() {
    return singletonList(
        new SearchExtSpec<>(
            LoggingSearchExtBuilder.NAME,
            LoggingSearchExtBuilder::new,
  ...
  public List<ActionHandler<? extends ActionRequest, ? extends ActionResponse>> getActions() {
    return unmodifiableList(
        asList(
            ...
            new ActionHandler<>(
                AddFeaturesToSetAction.INSTANCE, TransportAddFeatureToSetAction.class),
            new ActionHandler<>(
                CreateModelFromSetAction.INSTANCE, TransportCreateModelFromSetAction.class),
    ...
    return unmodifiableList(
        asList(
            new NamedXContentRegistry.Entry(
                ...
                (CheckedFunction<XContentParser, StorableElement, IOException>)
                    StoredFeature::parse),
            new NamedXContentRegistry.Entry(
                StorableElement.class,
  ...
  private LTRStats getStats(
    ...
    stats.put(StatName.CACHE.getName(), new LTRStat(false, new CacheStatsOnNodeSupplier(caches)));
    stats.put(
        StatName.STORES.getName(),
        new LTRStat(
            true, new StoreStatsSupplier(client, clusterService, indexNameExpressionResolver)));
    stats.put(
        StatName.PLUGIN_STATUS.getName(),
        new LTRStat(
            true, new PluginHealthStatusSupplier(clusterService, indexNameExpressionResolver)));
  ...
  protected FeatureStoreLoader getFeatureStoreLoader() {
    return (storeName, clientSupplier) ->
        new CachedFeatureStore(
            new IndexFeatureStore(storeName, clientSupplier, parserFactory), caches);
  }
  ...
  public List<PreConfiguredTokenFilter> getPreConfiguredTokenFilters() {
    return Arrays.asList(
        ...
        PreConfiguredTokenFilter.singleton(
            "ltr_length", true, (ts) -> new LengthFilter(ts, 0, STORABLE_ELEMENT_MAX_NAME_SIZE)));
  }

  public List<PreConfiguredTokenizer> getPreConfiguredTokenizers() {
    return Collections.singletonList(
        PreConfiguredTokenizer.singleton(
            "ltr_keyword", () -> new KeywordTokenizer(KeywordTokenizer.DEFAULT_BUFFER_SIZE)));
  }
}
